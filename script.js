...
const form =
    document.getElementById("instrutorForm");
...
async function carregarCidades(uf) {
    ...
    try {
        ...
        const resposta = await fetch(
            `${API_IBGE}/estados/${uf}/municipios?orderBy=nome`
        );
...
form.addEventListener(
    ...
    function (event) {
        ...
        if (!termos.checked) {
            ...
            alert(
                "É necessário autorizar o uso dos dados para continuar."
            );
         ...
         * aqui.
         *
         * O navegador continuará o envio
         * normal para o FormSubmit.
         */
