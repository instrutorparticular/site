...
form.addEventListener("submit", function (event) {
    ...
    /* ------------------------------
       ...
       (Deixar o formulário enviar normalmente)
    ------------------------------ */
    ...
    // Enviar o formulário usando form.submit()
    // Isso envia os dados para o FormSubmit
    setTimeout(function() {
        form.submit();
    }, 100);

    // Redirecionar para obrigado.html após o envio
    setTimeout(function() {
